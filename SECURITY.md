...
If you discover a vulnerability in Cascade, please follow these steps:

1. **Report the vulnerability**: Open an issue on our [GitHub repository](https://github.com/MemerGamer/Cascade/issues) with a detailed description of the issue, including steps to reproduce and any potential impact. Make sure to label the issue as a security vulnerability.
...
Thank you for helping us keep Cascade safe and secure for everyone.
